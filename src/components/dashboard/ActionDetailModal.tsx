...
import { X, BatteryCharging, Zap, ArrowUpRight, ShieldCheck, CheckCircle2, Fan, Sun, Info } from 'lucide-react';
...
export function ActionDetailModal({ action, currentSoc, onClose, onExecute }: ActionDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl sm:rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-4 sm:p-6 relative flex flex-col gap-4 sm:gap-5">
        {/* Header */}
